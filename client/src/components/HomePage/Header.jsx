  ...
  return (
    <div className="container flex justify-between items-center p-4  mx-auto max-w-full relative ">
        ...
        <ul className="space-x-8 text-white text-lg font-bold hidden md:flex">
          ...
          {state.active > 0 ? (
            <>
              ...
              <li className="text-[#CFB299] text-xl font-bold hover:text-[#9F643D] hover:scale-110 transition duration-300 ease-in-out">
      ...
      <div onClick={handleNav} className="block md:hidden">
        {!nav ? (
          <AiOutlineClose size={35} className="text-[#61493C]" />
        ) : (
          <AiOutlineMenu size={35} className="text-[#CFB299]" />
        )}
      </div>
      ...
      <div
        className={
          !nav
            ? "fixed  z-50 left-0 top-0 w-[50%] h-full border-r border-r-gray-900  bg-[black] opacity-80 ease-in-out duration-500"
            : "fixed left-[-100%] ease-in-out duration-500"
        }
      >
        <ul className="pt-24 uppercase ">
          <li className="p-4 border-b-2 border-[#9F643D] text-[#CFB299]">
            <a href="/">Home</a>
          </li>
          <li className="p-4 border-b-2 border-[#9F643D]  text-[#CFB299]">
            <a href="/">About</a>
