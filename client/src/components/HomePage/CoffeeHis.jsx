        ...
        <section className="w-full p-10 md:w-1/2 md:px-32 hover:scale-105 transition duration-300 ease-in-out cursor-pointer">
          <div className="flex flex-col justify-center items-center h-full text-center">
            ...
            <p className="md:text-lg font-medium">
              ...
              the ancient coffee forests on the Ethiopian plateau. There, legend
              says the goat herder Kaldi first discovered the potential of these
              beloved beans. The story goes that that Kaldi discovered coffee
              after he noticed that after eating the berries from a certain
              tree, his goats became so energetic that they did not want to
              sleep at night. Kaldi reported his findings to the abbot of the
              local monastery, who made a drink with the berries and found that
              it kept him alert through the long hours of evening prayer. The
              abbot shared his discovery with the other monks at the monastery,
              and knowledge of the energizing berries began to spread. As word
              moved east and coffee reached the Arabian peninsula, it began a
        ...
        >
          <div className="relative z-10 flex justify-center items-center h-full">
            <img
              ...
              className="max-w-full rounded-lg h-auto ml-auto md:-ml-40 sm:ml-0 lg:-mr-100"
            />
          </div>
        </motion.section>
      </div>
