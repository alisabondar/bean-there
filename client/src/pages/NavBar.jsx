    ...
    <div className='blurred'>
      <div className="mx-auto max-w-7xl px-2 py-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          <div>
          <img src={logoImage} alt="MyCompany Logo" className="image-h w-auto mr-2 rounded-lg "/>
          </div>
          ...
          ">
            ...
            <div className="hover:scale-110 transition duration-300 ease-in-out">
                ...
                >
                  ...
                  <img className="h-10 w- rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="User Profile" />
                </button>
              </div>
              {isDropdownOpen && (
