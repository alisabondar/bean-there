        ...
        {room !== null? (
          <>
            ...
            <div className="flex w-full h-[50-px] bg-[black] items-center p-3">
              <textarea className="textarea resize-none w-[65%] h-[50%]" placeholder={`Message ${room.chat_name}`}></textarea>
              <button className="btn btn-primary h-full ml-3 w-[75px] h-[50%]">send</button>
            </div>
          </>
        ) : <>Loading Mesages...</>}
      </div>
