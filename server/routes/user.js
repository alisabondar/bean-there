...
var { login, register, googleLogin, googleCB, githubLogin, githubCB, getWishlist, getUserReviews, getFriends, updateWishlist, getProfile, verifyOtp } = require("../controllers/usersController");
